...
private const val ACTIVITY = "com.instagram.extension.RestartActivity"

/** Its own process is the whole point: see RestartActivity. */
private const val PROCESS = ":instagram_restart"
...
val restartRelayPatch = resourcePatch(
    name = "Restart relay",
    description = "Declares the one-shot activity Instagram runs in its own process to bring " +
