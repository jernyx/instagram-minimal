...
import com.instagram.extension.Config;
 ...
 * point to the Instagram settings and is otherwise undiscoverable (people do
...
public final class Onboarding {
    ...
    private static final class SpotlightView extends FrameLayout {
        ...
        private static View buildCard(Context context) {
            ...
            body.setText("Press and hold the Home button below to open Instagram "
