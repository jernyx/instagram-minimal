...
/**
 * Runtime configuration backed by SharedPreferences ("instagram_prefs").
 *
...
public final class Config {
    ...
    public static boolean isAutoUpdateEnabled() {
        return getBlocked("auto_update", false);
    }
    ...
    public static boolean isProfileGridBlocked() { return getBlocked("block_profile_grid", true); }

    public static boolean isSearchPostsBlocked() { return getBlocked("block_search_posts", true); }
    ...
    public static boolean navDefault(String key) {
        return !"nav_show_reels".equals(key) && !"nav_show_profile".equals(key);
    }
