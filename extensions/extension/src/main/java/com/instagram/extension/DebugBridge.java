...
/**
 * Development-only ADB bridge: drives Instagram's settings from a shell instead
 ...
 *
 * <pre>
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.DUMP
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.SET \
 *     --es key block_ads --ez value true
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.SET \
 *     --es key landing_page --es value search
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.NAV
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.TRACE --ez value true
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.UPDATE
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.WHATSNEW
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.RESET
 * adb shell am broadcast -p com.instagram.android -a com.instagram.debug.RESTART
 * </pre>
 *
...
public final class DebugBridge {
    ...
    public static final String TAG = "InstaDebug";

    private static final String PREFIX = "com.instagram.debug.";
    ...
    private static String handle(Context context, String command, Intent intent) {
        switch (command) {
            ...
            case "TRACE":
                ...
                return "network trace " + (sNetworkTrace ? "on (logcat -s InstaNet:I)" : "off");
            case "RESET":
                return reset();
            case "RESTART":
